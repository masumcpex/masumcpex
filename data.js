...
const SITE_DATA = {
  ...
  journal: [
    ...
    {
      id: "j10",
      title: "শুকনো ফুলের মালা জানে",
      category: "অনুভূতি",
      date: "২০২৬-০৮-০৭",
      readingTime: "১ মিনিট",
      image: "",
      excerpt: "শুকনো ফুলের মালা জানে, কেউ একদিন এসেছিল — আর চড়ুই পাখিরা জানে, আমি এখনও প্রতীক্ষায় বসে আছি।",
      url: "",
      content: "শুকনো ফুলের মালা জানে,\nকেউ একদিন এসেছিল।\nচড়ুই পাখিরা জানে,\nআমি এখনও প্রতীক্ষায় বসে আছি।\nএলাচের দানা জানে,\nকোনো একদিন ঠোঁট আবার গন্ধময় হবে।"
    },
    {
      id: "j11",
      title: "নীরবে আমাকে ডাকে",
      category: "অনুভূতি",
      date: "২০২৬-০৮-০৭",
      readingTime: "১ মিনিট",
      image: "",
      excerpt: "তুমি ব্যস্ত, তুমি একা, তুমি অন্তরালে — তবুও ভালোবাসা নীরবে আমাকে ডাকে।",
      url: "",
      content: "তুমি ব্যস্ত,\nতুমি একা,\nতুমি অন্তরালে।\nতবুও ভালোবাসা\nসন্ন্যাসীর মন্ত্রের মতো\nনীরবে আমাকে ডাকে।"
    },
    {
      id: "j12",
      title: "অপেক্ষার ঠিক সেখানেই",
      category: "অনুভূতি",
      date: "২০২৬-০৮-০৭",
      readingTime: "১ মিনিট",
      image: "",
      excerpt: "তুমি যেখানেই থাকো, আমিও অপেক্ষার ঠিক সেখানেই আছি।",
      url: "",
      content: "তুমি যেখানেই থাকো,\nআমিও অপেক্ষার ঠিক সেখানেই আছি।"
    }
  ],
